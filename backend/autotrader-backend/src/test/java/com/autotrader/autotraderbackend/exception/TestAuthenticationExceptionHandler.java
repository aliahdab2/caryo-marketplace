...
/**
 * Test version of the global exception handler for authentication and authorization-related exceptions
 * This is used only for testing purposes
 */
@RestControllerAdvice
public class TestAuthenticationExceptionHandler {

    private static final Logger logger = LoggerFactory.getLogger(TestAuthenticationExceptionHandler.class);
