...
The AutoTrader email template system provides a comprehensive solution for managing all email communications in the application. It supports bilingual content (English/Arabic), responsive design, and easy customization.
...
logging.level.com.autotrader.autotraderbackend.service.EmailServiceImpl=DEBUG
```
