# Caryo Marketplace Backend

This is the backend service for the Caryo Marketplace application, built with Spring Boot.
...
│   ├── CaryoMarketplaceApplication.java    # Main application class
...
2. Import the collection and environment into Postman:
   - Collection: `src/test/resources/postman/caryo-api-tests.json`
...
- **Direct connection**: `jdbc:postgresql://localhost:5432/caryo`
