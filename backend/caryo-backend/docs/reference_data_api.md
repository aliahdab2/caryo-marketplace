...
This document outlines the API endpoints for accessing and managing reference data in the Caryo marketplace application. Reference data includes standard values for car attributes such as conditions, body styles, fuel types, etc.
