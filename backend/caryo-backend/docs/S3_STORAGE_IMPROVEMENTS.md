...
storage.bucket.default=${STORAGE_BUCKET_NAME:caryo-storage}
storage.bucket.images=${STORAGE_BUCKET_IMAGES:caryo-images}
storage.bucket.documents=${STORAGE_BUCKET_DOCUMENTS:caryo-docs}
