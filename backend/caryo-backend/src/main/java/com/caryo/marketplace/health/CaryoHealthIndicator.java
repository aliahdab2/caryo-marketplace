package com.caryo.marketplace.health;
...
public class CaryoHealthIndicator implements HealthIndicator {
    ...
    public Health health() {
        try {
            ...
            return Health.up()
                ...
                .withDetail("description", "Caryo backend service is running properly")
                .build();
        } catch (Exception e) {
