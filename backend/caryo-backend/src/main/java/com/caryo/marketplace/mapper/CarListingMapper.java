...
import com.caryo.marketplace.payload.response.FuelTypeResponse;
...
import com.caryo.marketplace.payload.response.TransmissionResponse;
...
public class CarListingMapper {
     ...
     */
    private ListingMediaResponse mapSingleMedia(Long listingId, com.caryo.marketplace.model.ListingMedia media) {
