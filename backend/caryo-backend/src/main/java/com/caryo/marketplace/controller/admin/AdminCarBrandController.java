...
import com.caryo.marketplace.payload.request.CreateCarBrandRequest;
import com.caryo.marketplace.payload.request.UpdateCarBrandRequest;
 ...
 */
@RestController
@RequestMapping("/api/v1/admin/car-brands")
