...
import com.caryo.marketplace.payload.response.CanCreateListingResponse;
...
import com.caryo.marketplace.service.DealerTrialService.TrialStatus;
...
public class DealerController {
    ...
    public ResponseEntity<DealerProfileResponse> updateDealerProfile(
            @AuthenticationPrincipal UserDetailsImpl userDetails,
            @RequestBody com.caryo.marketplace.payload.request.DealerProfileUpdateRequest updateRequest) {
