...
```properties
logging.level.com.caryo.caryomarketplace.service.EmailTemplateService=DEBUG
logging.level.com.caryo.caryomarketplace.service.EmailTemplateValidationService=DEBUG
