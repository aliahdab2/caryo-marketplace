...
import com.caryo.marketplace.model.Role; // Import Role
...
public class AdminListingStatusIntegrationTest extends IntegrationTestWithS3 {
    ...
    public void setUp() throws Exception {
        ...
        com.caryo.marketplace.model.Country savedCountry = TestDataGenerator.createOrFindTestCountry("SY", countryRepository);
    ...
    public void adminCanMarkListingAsSold() throws Exception {
        ...
        mockMvc.perform(post("/api/v1/admin/listings/{id}/mark-sold", listingId)
    ...
    public void adminCanUnarchiveListing() throws Exception {
        ...
        mockMvc.perform(post("/api/v1/admin/listings/{id}/unarchive", listingId)
                .header("Authorization", "Bearer " + adminToken)
                .contentType(MediaType.APPLICATION_JSON))
                .andExpect(status().isOk())
                .andExpect(jsonPath("$.id").value(listingId))
