 ...
 * Tests the business logic for handling Caryo contact pattern.
 */
@ExtendWith(MockitoExtension.class)
@DisplayName("CarListingService Contact Fields Tests (Caryo Pattern)")
class CarListingContactFieldsServiceTest {
    ...
    class CreateListingContactTests {
        ...
        void createListing_WithCustomContactFields_ShouldSetCorrectly() {
            ...
            when(carListingRepository.countActiveListingsByUser(testUser)).thenReturn(0L); // Regular user with 0 listings
