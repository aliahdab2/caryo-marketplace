...
import com.caryo.marketplace.payload.request.LocationRequest;
import com.caryo.marketplace.payload.response.LocationResponse;
import com.caryo.marketplace.service.LocationService;
...
@WebMvcTest(controllers = LocationController.class,
    includeFilters = @ComponentScan.Filter(type = FilterType.ASSIGNABLE_TYPE,
        classes = com.caryo.marketplace.exception.GlobalExceptionHandler.class))
...
class LocationControllerTests {
    ...
    @MockBean private com.caryo.marketplace.security.jwt.JwtUtils jwtUtils;
    @MockBean private com.caryo.marketplace.security.services.UserDetailsServiceImpl userDetailsService;
