...
import com.caryo.marketplace.repository.LocationRepository;
...
/**
 * Integration tests for the Caryo contact fields functionality.
...
@ActiveProfiles("test")
@Transactional
@DisplayName("Contact Fields Integration Tests (Caryo Pattern)")
public class ContactFieldsIntegrationTest {
    ...
    @BeforeEach
    void setUp() {
        // Create test user (seller) with unique email to avoid conflicts
        testUser = new User();
        testUser.setUsername("testdealer"); // Must match @WithMockUser username
        testUser.setEmail("contactfields@test.caryo.sy");
    ...
    class CreateListingTests {
        ...
        void createListing_WithoutContactFields_ShouldFallbackToSeller() throws Exception {
            ...
            mockMvc.perform(post("/api/listings")
                    ...
                    .andExpect(jsonPath("$.contactEmail").value("contactfields@test.caryo.sy")) // Fallback to user email
        ...
        void createListing_WithPartialContactFields_ShouldMixCustomAndFallback() throws Exception {
            ...
            mockMvc.perform(post("/api/listings")
                    ...
                    .andExpect(jsonPath("$.contactEmail").value("contactfields@test.caryo.sy")) // Fallback
    ...
    class RetrieveListingTests {
        ...
        void getListing_WithContactFields_ShouldReturnCorrectPriority() throws Exception {
            ...
            mockMvc.perform(get("/api/listings/my-listings"))
                    ...
                    .andExpect(jsonPath("$[0].sellerEmail").value("contactfields@test.caryo.sy"));
        }
    }
