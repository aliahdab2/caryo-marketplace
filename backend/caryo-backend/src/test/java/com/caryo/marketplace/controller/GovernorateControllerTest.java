...
import com.caryo.marketplace.service.GovernorateService;
...
class GovernorateControllerTest {
    ...
    @MockBean
    private com.caryo.marketplace.security.jwt.JwtUtils jwtUtils;

    @MockBean
    private com.caryo.marketplace.security.services.UserDetailsServiceImpl userDetailsService;
