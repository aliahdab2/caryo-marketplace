# Caryo API Tests Postman Collection

This directory contains Postman collections for testing the Caryo Marketplace API.
...
- `caryo-api-collection.json`: The main collection file with all test requests embedded directly
...
- A running instance of the Caryo backend application (by default at http://localhost:8080)
...
- `baseUrl`: Base URL of the Caryo API (default: http://localhost:8080)
