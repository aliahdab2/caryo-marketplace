...
# Caryo CLI - Simplified command-line interface for Caryo Backend
# 
# This script provides a simplified interface for common development tasks
#
# Usage: ./caryo.sh [command] [options]
#
...
print_help() {
  echo -e "${CYAN}Usage:${NC} ./caryo.sh [command] [options]"
  echo
  ...
  echo -e "  ${GREEN}./caryo.sh dev start${NC}                      - Start dev environment"
  echo -e "  ${GREEN}./caryo.sh dev start --rebuild${NC}            - Rebuild and start dev environment" 
  echo -e "  ${GREEN}./caryo.sh dev start --rebuild --skip-tests${NC} - Rebuild without tests and start dev environment"
  echo -e "  ${GREEN}./caryo.sh dev rebuild${NC}                    - Rebuild dev environment"
  echo -e "  ${GREEN}./caryo.sh dev rebuild-notest${NC}             - Rebuild dev environment without tests"
  echo -e "  ${GREEN}./caryo.sh dev stop${NC}                       - Stop dev environment"
  echo -e "  ${GREEN}./caryo.sh api start${NC}                      - Start API server"
  echo -e "  ${GREEN}./caryo.sh prod deploy${NC}                   - Build and deploy production"
  echo -e "  ${GREEN}./caryo.sh prod rebuild${NC}                  - Rebuild production (no data seeding)"
  echo -e "  ${GREEN}./caryo.sh prod clean-rebuild${NC}           - Wipe DB/volumes and rebuild from scratch"
  echo -e "  ${GREEN}./caryo.sh prod backup${NC}                   - Create DB/uploads/logs backups"
  echo -e "  ${GREEN}./caryo.sh prod health${NC}                   - Check production health"
  echo -e "  ${GREEN}./caryo.sh test all${NC}                       - Run all tests"
  echo -e "  ${GREEN}./caryo.sh test auth${NC}             - Run auth tests"
  echo -e "  ${GREEN}./caryo.sh test endpoints${NC}        - Test API endpoints"
  echo -e "  ${GREEN}./caryo.sh docs generate${NC}         - Generate API docs"
  echo
}
