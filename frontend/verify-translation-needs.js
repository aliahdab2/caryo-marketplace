...
function displayResults(neededIncomplete, incompleteTranslations) {
  ...
  console.log(`Potentially unnecessary: ${stats.unneeded} (${((stats.unneeded / incompleteTranslations.totalIncomplete) * 100).toFixed(1)}%)`);

  if (stats.needed === incompleteTranslations.totalIncomplete) {
