...
export default function SignUpPage() {
  ...
  const { isRTL, dir, textAlign, flexDirection, marginEnd } = useRTL();
  ...
  return (
    <div className="min-h-screen flex flex-col md:flex-row bg-gradient-to-br from-gray-50 via-white to-gray-100 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 animate-fade-in" dir={dir}>
      ...
      <div className={`hidden md:flex md:w-2/5 lg:w-1/3 xl:w-1/4 bg-gradient-to-br from-blue-600 via-blue-700 to-indigo-800 text-white flex-col justify-between relative overflow-hidden shadow-2xl ${isRTL ? 'md:order-2' : 'md:order-1'}`}>
        ...
        <div className={`z-10 p-6 md:p-8 lg:p-10 flex flex-col ${textAlign} animate-slide-in-left`}>
          <div className={`flex items-center mb-8 ${flexDirection} group`}>
            <div className="h-12 w-12 relative flex-shrink-0 transform group-hover:scale-110 transition-transform duration-300">
              <NextImage
                ...
                width={48}
                height={48}
                className={`w-10 h-10 md:w-12 md:h-12 object-contain filter invert drop-shadow-lg ${marginEnd('3')} md:${marginEnd('4')}`}
                priority
              />
            </div>
          ...
          <div className="space-y-4 mb-8">
            <h2 className={`text-3xl md:text-4xl font-bold leading-tight ${textAlign} bg-gradient-to-r from-white to-blue-100 bg-clip-text text-transparent`}>
              {t('joinUs')}
            </h2>
            <p className={`text-base md:text-lg opacity-90 leading-relaxed ${textAlign} max-w-sm`}>
          ...
          <div className="space-y-6">
            <div className="flex items-start group hover:bg-white/5 rounded-lg p-3 -m-3 transition-all duration-300" dir={dir}>
              <div className={`flex-shrink-0 w-10 h-10 bg-gradient-to-r from-green-400 to-emerald-500 rounded-full flex items-center justify-center mt-0.5 shadow-lg group-hover:shadow-xl transition-shadow duration-300 ${marginEnd('4')}`}>
            ...
            <div className="flex items-start group hover:bg-white/5 rounded-lg p-3 -m-3 transition-all duration-300" dir={dir}>
              <div className={`flex-shrink-0 w-10 h-10 bg-gradient-to-r from-blue-400 to-cyan-500 rounded-full flex items-center justify-center mt-0.5 shadow-lg group-hover:shadow-xl transition-shadow duration-300 ${marginEnd('4')}`}>
                <svg className="w-5 h-5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div className="flex items-start group hover:bg-white/5 rounded-lg p-3 -m-3 transition-all duration-300" dir={dir}>
              <div className={`flex-shrink-0 w-10 h-10 bg-gradient-to-r from-purple-400 to-pink-500 rounded-full flex items-center justify-center mt-0.5 shadow-lg group-hover:shadow-xl transition-shadow duration-300 ${marginEnd('4')}`}>
                <svg className="w-5 h-5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className={`z-10 p-6 md:p-8 lg:p-10 ${textAlign} border-t border-white/10`}>
      ...
      <div className={`flex-1 flex justify-center items-start pt-4 md:pt-6 lg:pt-8 xl:pt-10 pb-4 md:pb-6 lg:pb-8 xl:pb-10 px-4 md:px-6 lg:px-8 xl:px-10 auth-container ${isRTL ? 'md:order-1' : 'md:order-2'} animate-slide-in-right`}>
        <div className="w-full max-w-md md:max-w-lg lg:max-w-xl mt-0 mb-auto">
          ...
          <div className="flex md:hidden items-center justify-center mb-8 sm:mb-10">
            <div className={`flex items-center animate-fade-in-up ${flexDirection} group`}>
              <div className="relative">
                <NextImage
                  ...
                  width={44}
                  height={44}
                  className={`w-10 h-10 sm:w-11 sm:h-11 object-contain drop-shadow-md group-hover:scale-110 transition-transform duration-300 ${marginEnd('3')} sm:${marginEnd('4')}`}
                  priority
                />
          ...
          <div className="mb-6 md:mb-8">
            ...
            <div className="w-full bg-gray-200 dark:bg-gray-700 rounded-full h-1">
              <div className="bg-gradient-to-r from-blue-500 to-indigo-600 h-1 rounded-full animate-pulse" style={{width: '25%'}}></div>
            </div>
          </div>
          ...
          <div className="mt-8 pt-6 border-t border-gray-200 dark:border-gray-700">
            <div className={`flex items-center justify-center ${flexDirection} text-xs text-gray-500 dark:text-gray-400 space-y-2 md:space-y-0 md:space-x-6`}>
