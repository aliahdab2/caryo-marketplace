...
export default function AdvancedSearchPage() {
  ...
  console.log('Search page loaded with params:', Object.fromEntries(searchParams.entries()));
  ...
  useEffect(() => {
    ...
    console.log('Search page: Initializing filters from URL params', {
    ...
    console.log('Search page: Parsed URL params', { brands, models });
    ...
    console.log('Search page: Setting initial filters', initialFilters);
