...
import { CarListing, subscribeToNewsletter, Governorate } from "@/services/publicApi";
...
export default function HomeClient({
  ...
  // Prevent hydration mismatch by checking if translation is ready
  // Although with SSR, main content should be robust.
  // We can just render. content might flicker if keys differ, but initialCars are there.
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center px-4 hero-absolute-content z-10">
          ...
          >
            <h1 className="text-3xl xs:text-4xl md:text-5xl font-bold text-white mb-4 drop-shadow-md">
              {t('heroTitle', { ns: 'home', defaultValue: 'Find Your Dream Car' })}
            </h1>

            <p className="text-lg xs:text-xl md:text-2xl text-white/90 max-w-2xl mx-auto font-medium drop-shadow">
              {t('heroSubtitle', { ns: 'home', defaultValue: 'The most trusted marketplace for buying and selling cars' })}
            </p>
          </motion.div>
          ...
          >
            <HomeSearchBar 
              ...
              initialGovernorates={initialGovernorates} 
            />
          </motion.div>
        </div>
      </div>
      ...
      <section className="py-20 bg-gradient-to-b from-gray-50 to-white dark:from-gray-900 dark:to-gray-800">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl md:text-4xl font-bold text-center mb-4 text-gray-900 dark:text-white">
            {t('whyChooseUsTitle', { ns: 'home', defaultValue: 'Why Choose Us' })}
          </h2>
          <p className="text-center text-gray-600 dark:text-gray-400 mb-12 max-w-2xl mx-auto">
            {t('whyChooseUsSubtitle', { ns: 'home', defaultValue: 'Discover why thousands trust Caryo for their automotive needs' })}
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            ...
            <div className="group relative bg-white/80 dark:bg-gray-800/80 backdrop-blur-md rounded-2xl p-8 shadow-lg hover:shadow-2xl transition-all duration-300 hover:-translate-y-2 border border-gray-200/50 dark:border-gray-700/50 hover:border-blue-300 dark:hover:border-blue-600">
              ...
              <div className="relative">
                ...
                <h3 className="text-xl font-bold mb-3 text-gray-900 dark:text-white">{t('whyChooseUsWideSelectionTitle', { ns: 'home', defaultValue: 'Wide Selection' })}</h3>
                <p className="text-gray-600 dark:text-gray-300 leading-relaxed">{t('whyChooseUsWideSelectionDescription', { ns: 'home', defaultValue: 'Browse thousands of verified cars from trusted sellers' })}</p>
              </div>
            </div>
            ...
            <div className="group relative bg-white/80 dark:bg-gray-800/80 backdrop-blur-md rounded-2xl p-8 shadow-lg hover:shadow-2xl transition-all duration-300 hover:-translate-y-2 border border-gray-200/50 dark:border-gray-700/50 hover:border-purple-300 dark:hover:border-purple-600">
              ...
              <div className="relative">
                ...
                <h3 className="text-xl font-bold mb-3 text-gray-900 dark:text-white">{t('whyChooseUsSecureTransactionsTitle', { ns: 'home', defaultValue: 'Trusted Sellers' })}</h3>
                <p className="text-gray-600 dark:text-gray-300 leading-relaxed">{t('whyChooseUsSecureTransactionsDescription', { ns: 'home', defaultValue: 'Every seller is verified to ensure a safe buying experience' })}</p>
              </div>
            </div>
            ...
            <div className="group relative bg-white/80 dark:bg-gray-800/80 backdrop-blur-md rounded-2xl p-8 shadow-lg hover:shadow-2xl transition-all duration-300 hover:-translate-y-2 border border-gray-200/50 dark:border-gray-700/50 hover:border-green-300 dark:hover:border-green-600">
              ...
              <div className="relative">
                ...
                <h3 className="text-xl font-bold mb-3 text-gray-900 dark:text-white">{t('whyChooseUsExpertSupportTitle', { ns: 'home', defaultValue: 'Expert Support' })}</h3>
                <p className="text-gray-600 dark:text-gray-300 leading-relaxed">{t('whyChooseUsExpertSupportDescription', { ns: 'home', defaultValue: 'We are here to help you every step of the way' })}</p>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="max-w-4xl mx-auto bg-blue-50/50 dark:bg-blue-900/10 backdrop-blur-sm rounded-3xl p-8 md:p-12 border border-blue-100 dark:border-blue-800/20 text-center relative overflow-hidden shadow-xl shadow-blue-500/5">
            ...
            <div className="relative z-10">
              <h2 id="newsletter-title" className="text-2xl md:text-3xl font-bold mb-4 text-gray-900 dark:text-white">
                {t('stayUpdated', { ns: 'home', defaultValue: 'Stay Updated' })}
              </h2>
              <p id="newsletter-description" className="text-gray-600 dark:text-gray-400 max-w-xl mx-auto mb-8">
                {t('newsletterDescription', { ns: 'home', defaultValue: 'Subscribe to our newsletter to get the latest updates and offers' })}
              </p>
              ...
              <form onSubmit={handleNewsletterSubmit} className="max-w-md mx-auto flex flex-col sm:flex-row gap-3" aria-describedby="newsletter-description">
                <input
                  ...
                  placeholder={t('emailPlaceholder', { ns: 'home', defaultValue: 'Enter your email' })}
