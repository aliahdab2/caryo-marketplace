    ...
    <div className="h-12 flex items-center">
      ...
      <div className="relative w-full h-12">
        <select
          ...
          className="appearance-none block w-full h-12 pl-3 pr-8 py-2 text-sm border-0 focus:outline-none focus:ring-2 focus:ring-blue-500 rounded-xl bg-gray-100 dark:bg-gray-800 text-gray-900 dark:text-white placeholder-gray-500 transition-colors duration-200 hover:bg-gray-200 dark:hover:bg-gray-700 focus:bg-white dark:focus:bg-gray-900 disabled:cursor-not-allowed disabled:opacity-50 overflow-hidden text-ellipsis whitespace-nowrap no-anim-select"
          disabled={isDisabled}
