  ...
  describe('Data Transformation', () => {
    it('transforms CarListing to CarListingCardData format correctly', () => {
      const listingWithAllFields: CarListing = {
        ...
        modelYear: 2021,
        mileage: 25000,
        transmission: { id: 2, name: 'manual', slug: 'manual', displayNameEn: 'Manual', displayNameAr: 'يدوي' },
        fuelType: { id: 2, name: 'diesel', slug: 'diesel', displayNameEn: 'Diesel', displayNameAr: 'ديزل' },
