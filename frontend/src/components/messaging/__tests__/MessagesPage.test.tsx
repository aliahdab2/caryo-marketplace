...
const createMockConversation = (overrides?: Partial<ConversationResponse>): ConversationResponse => ({
  ...
  listingPrice: '25000',
  listingCurrency: 'USD',
  buyer: { id: 2, username: 'buyer_user', email: 'buyer@example.com', profileImageUrl: undefined },
  seller: { id: 1, username: 'seller_user', email: 'seller@example.com', profileImageUrl: undefined },
